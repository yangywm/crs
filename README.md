...
[![Docker Build](https://github.com/yangywm/crs/actions/workflows/auto-release-pipeline.yml/badge.svg)](https://github.com/yangywm/crs/actions/workflows/auto-release-pipeline.yml)
[![Docker Pulls](https://img.shields.io/docker/pulls/yangywm/crs)](https://hub.docker.com/r/yangywm/crs)
...
```bash
# 下载并运行管理脚本
curl -fsSL https://raw.githubusercontent.com/yangywm/crs/main/scripts/manage.sh -o manage.sh
chmod +x manage.sh
./manage.sh install
...
docker pull yangywm/crs:latest
...
- Docker 部署：查看容器日志 `docker logs crs`
